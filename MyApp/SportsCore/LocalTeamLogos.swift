...
nonisolated enum TeamLogoAssetResolver {
    ...
    static func nbaAssetURL(abbreviation: String?, displayName: String? = nil) -> URL? {
    ...
    static func wnbaAssetURL(abbreviation: String?, displayName: String? = nil) -> URL? {
        let abbreviation = normalizedAbbreviation(abbreviation) ?? displayName.flatMap { wnbaNameAbbreviations[normalizedName($0)] }
        return abbreviation.flatMap { URL.bannerImageAsset(named: "WNBALogo_\($0)") }
    }

    static func nflAssetURL(abbreviation: String?, displayName: String? = nil) -> URL? {
    ...
    static func soccerAssetURL(leaguePath: String, displayName: String?) -> URL? {
    ...
    static func normalizedAbbreviation(_ value: String?) -> String? {
    ...
    static func assetSuffix(_ value: String) -> String {
        value
    ...
    private static func msiLeagueName(for leaguePath: String) -> String? {
        switch leaguePath {
    ...
    private static let nbaNameAbbreviations: [String: String] = [
    ...
    private static let wnbaNameAbbreviations: [String: String] = [
    ...
    private static let nflNameAbbreviations: [String: String] = [
    ...
    private static let nhlNameAbbreviations: [String: String] = [
    ...
    private static let nhlAbbreviationAliases: [String: String] = [
        "LA": "LAK",
        "SJ": "SJS",
        "TB": "TBL",
        "UTA HC": "UTA",
    ...
    private static let mlbAbbreviationAssets: [String: String] = [
    ...
    private static let mlbProviderIDAssets: [String: String] = [
