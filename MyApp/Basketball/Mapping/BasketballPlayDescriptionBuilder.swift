...
/// NBA/WNBA's live play-by-play `description` field already reads as a complete
...
/// and never claims more than the supplied fields actually say. Operates purely
/// on the canonical `NBAPlayType`/primitives, so it's shared as-is between leagues.
nonisolated enum BasketballPlayDescriptionBuilder {
