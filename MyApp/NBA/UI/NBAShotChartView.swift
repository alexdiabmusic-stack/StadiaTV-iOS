...
/// A half-court shot chart driven by `NBACourtCoordinateTransformer`'s output —
/// the transformer and `BasketballGameSnapshot.shots` exist only for this view.
struct NBAShotChartView: View {
